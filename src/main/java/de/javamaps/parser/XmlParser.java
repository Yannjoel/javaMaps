...
public class XmlParser {
	...
	private static URL targetUrl = XmlParser.class.getResource(target);
	...
	public static void main(String[] args) throws XMLStreamException, IOException {
		FileInputStream sourceFileInputStream = new FileInputStream(sourceUrl.getFile());
		BufferedInputStream in = new BufferedInputStream(sourceFileInputStream);
...
// informationen zu nodes
		...
		sourceFileInputStream = new FileInputStream(source);
		in = new BufferedInputStream(sourceFileInputStream);
		try {
			datastream = new BZip2CompressorInputStream(in);
		} catch (IOException e) {
			throw e;
